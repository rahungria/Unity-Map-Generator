...
public class HexMesh : MonoBehaviour {
    ...
    Vector3 Perturb (Vector3 position){
        ...
        position.x += sample.x * (2f - 1f) * HexMetrics.perturbStrenght;
        //position.y += sample.y * (2f - 1f) * HexMetrics.elevationPerturbStrenght;
        position.z += sample.z * (2f - 1f) * HexMetrics.perturbStrenght;
